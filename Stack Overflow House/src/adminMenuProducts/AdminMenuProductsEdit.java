...
public class AdminMenuProductsEdit extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AdminMenuProductsEdit frame = new AdminMenuProductsEdit("", null,null,null,null,null,null,null);
	...
	public AdminMenuProductsEdit(String rut, SQL_Manager connection,CartImpl cartImpl,CategoryImpl categoryImpl,CommentaryImpl commentaryImpl,ProductImpl productImpl,
		...
		int cant = 10;
		try {
			cant = productImpl.countProductsEdit(connection);
		} catch (NumberFormatException e3) {
			e3.printStackTrace();
		}
		String[] list = new String[cant];
		String[] values = null;
		values = productImpl.getProducts(connection, list);
