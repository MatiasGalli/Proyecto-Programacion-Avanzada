...
public class Login extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Login frame = new Login(null,null,null,null,null,null,null);
	 ...
	 * Create the frame.
	 */
	public Login(SQL_Manager connection,CartImpl cartImpl,CategoryImpl categoryImpl,CommentaryImpl commentaryImpl,ProductImpl productImpl,
	PurchaseImpl purchaseImpl, UserImpl userImpl) {
		...
		btn_register.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Register v2 = new Register("",false, connection,cartImpl,categoryImpl,commentaryImpl,productImpl,purchaseImpl,userImpl);
		...
		btn_signIn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (userEmpty) {
					...
					productExist = productImpl.existProduct(connection);
					if (rut == null) {
						JFrame jFrame = new JFrame();
						jFrame.setAlwaysOnTop(true);
						...
						JFrame jFrame = new JFrame();
						jFrame.setAlwaysOnTop(true);
						JOptionPane.showMessageDialog(jFrame, "No hay productos que mostrar. Por favor, vuelva en otro momento");
					} else {
						if (!banned) {
							if (!admin) {
								UserMenu v3 = new UserMenu(name, connection,cartImpl,categoryImpl,commentaryImpl,productImpl,purchaseImpl,userImpl);
