...
public class AdminMenuChangePassword extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AdminMenuChangePassword frame = new AdminMenuChangePassword("",null);
	 ...
	 * Create the frame.
	 */
	public AdminMenuChangePassword(String rut, SQL_Manager connection) {
		...
		btn_changePassword.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					exist = selectCurrentPassword(connection,rut,currentPassword);
				...
				if (currentPassword.equals("")) {
					...
					try {
						editPassword(rut,connection,newPassword);
					} catch (SQLException e1) {
						e1.printStackTrace();
					}
				}
	...
	public void editPassword(String rut, SQL_Manager connection, String newPassword) throws SQLException {
		String sql;
