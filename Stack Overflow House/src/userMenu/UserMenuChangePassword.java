...
public class UserMenuChangePassword extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					UserMenuChangePassword frame = new UserMenuChangePassword("",null,null,null,null,null,null,null);
	 ...
	 * Create the frame.
	 */
	public UserMenuChangePassword(String user, SQL_Manager connection,CartImpl cartImpl,CategoryImpl categoryImpl,CommentaryImpl commentaryImpl,ProductImpl productImpl,
		...
		btn_changePassword.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					exist = userImpl.selectCurrentPassword(connection,user_rut,currentPassword);
				...
				if (currentPassword.equals("")) {
					...
					userImpl.editPassword(user_rut,connection,newPassword);
					UserMenuAccount v12 = new UserMenuAccount(user, connection,cartImpl,categoryImpl,commentaryImpl,productImpl,purchaseImpl,userImpl);
					v12.setLocationRelativeTo(null);
					v12.setVisible(true);
					dispose();
